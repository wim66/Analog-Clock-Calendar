...
local settings = {
    clock_border_color = {hex = "#4682B4", alpha = 1},   -- Clock border (Steel Blue)
    clock_border_width = 4,                              -- Thickness of the clock border (pixels)
    hour_number_color = {hex = "#FFA500", alpha = 1},    -- Hour numbers (Orange)
    hour_mark_color = {hex = "#87CEEB", alpha = 1},    -- Hour marks (Sky Blue)
    minute_mark_color = {hex = "#B0E0E6", alpha = 1},  -- Minute indicators (Powder Blue)
    ...
    glass_center_color = {hex = "#FFFFFF", alpha = 0.15}, -- Glass effect center (White, semi-transparent)
    glass_edge_color = {hex = "#FFFFFF", alpha = 0.1}       -- Glass effect edge (Fully transparent)
}
